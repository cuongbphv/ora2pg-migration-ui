...
;
const metadata = {
    title: "Ora2Pg Migration Tool - Oracle to PostgreSQL",
    description: "Professional database migration tool for converting Oracle databases to PostgreSQL with visual mapping and configuration",
    generator: 'v0.app'
};
